    ...
    public partial class NormalPainter : MonoBehaviour
    {
        ...
        public void UpdateNormals(bool mirror = true)
        {
            ...
            if (m_skinned)
            {
                ...
                m_meshTarget.SetNormals((List<Vector3>)m_normalsPredeformed);
            }
            else
            {
                if (mirror)
                    ApplyMirroringInternal();
                m_meshTarget.SetNormals((List<Vector3>)m_normals);
            }
        ...
        public void RecalculateTangents(TangentsPrecision precision, bool updateMesh = true)
        {
            ...
            if (updateMesh)
                m_meshTarget.SetTangents((List<Vector4>)m_tangentsPredeformed);
