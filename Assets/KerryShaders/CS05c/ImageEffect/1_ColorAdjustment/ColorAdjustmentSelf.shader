Shader "Hidden/ColorAdjustmentSelf"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (v2f_img i) : SV_Target
            {
				...
				//亮度
            	// finalcolor = col.rgb * _Brightness; Miss
				finalcolor = finalcolor * _Brightness;
            	
                //饱和度
                float lumin = dot(finalcolor,float3(0.2126,0.7152,0.0722));
            	...
            	//easy mode -> vfactor = 1.0 - length(i.uv - half2(0.5,0.5))
